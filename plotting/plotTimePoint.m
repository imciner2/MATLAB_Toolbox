function plotOutput = plotTimePoint(time, height, varargin)
%PLOTTIMEPOINT Plots a point on a time-based graph
% 
% PLOTTIMEPOINT(time, height,...) Plots a point at a specific time and
% height on a time-based graph without using any MATLAB builtin TimeSeries
% functions, which improves speed.
% 
% Arguments:
...
%
% See also: PLOTTIMEDATA, PLOTTIMEBAR, PLOT, SUBPLOT, HOLD
%
% 
...
plotOutput = plot(plotTime, height, plotOptions{1:length(plotOptions)});
